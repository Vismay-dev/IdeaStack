...
<div style = {{'backgroundImage':'url(https://www.ntaskmanager.com/wp-content/uploads/2021/06/types-of-teams.png)'}} data-aos={"fade-up"} data-aos-once='true' class = {`xl:col-span-3 bg-contain bg-bottom lg:col-span-2 col-span-1 ${project&&(project.maxCap - project.team.length===0||user._id!==project.admin.id)?'hidden':'block'} bg-gradient-to-br z-[75] md:h-[330px] h-[385px] mb-1.5 relative border-[1px] border-blue-700 rounded-md from-blue-50 to-indigo-200`}>
      ...
      <h3 class = 'font-bold text-center mx-auto relative mr-1 text-2xl'><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-1 relative bottom-[2.6px] font-bold text-blue-800 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
</svg><span class = 'inline'>Invite Other Users:</span></h3>
      <h3 class = 'font-semibold text-center mx-auto relative mt-1.5 top-1 text-xl'>(Remaining Team Capacity: {project&&(project.maxCap - project.team.length)})</h3>
...
setText('');
 ...
 class="pl-8 pr-2 py-2 z-[75] pointer-events-auto border-b-2 border-gray-200 relative cursor-pointer hover:bg-yellow-50 hover:text-gray-900">
      ...
      <h3 class = {`relative mx-auto block ${memberSelected?'mt-7':'md:mt-[36px] mt-12'}  text-center`}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline relative bottom-[3px] mr-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
:<button disabled={!memberSelected} onClick={sendInvite} class = {`${memberSelected?'from-indigo-300 to-indigo-500 shadow-md hover:shadow-lg active:shadow-sm md:mt-[24px] mt-[10px]':" from-indigo-200 to-indigo-300 sm:mt-5 mt-7"} left-1.5  bg-gradient-to-br text-white font-semibold p-3 relative mx-auto block rounded-md pt-2.5`}>Send Invite</button>
}
