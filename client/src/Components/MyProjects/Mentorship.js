  ...
  return (
    <>
      ...
      <h2
        style={{
          backgroundImage:
            "url(https://www.venafi.com/themes/venafi/images/redesign/blog-detail/blog_detail.jpg)",
        }}
        class="text-center bg-no-repeat bg-center bg-cover py-9 pb-[54px] font-bold shadow-lg xl:px-[365px] lg:px-[250px] md:px-[150px] sm:px-[100px] sm:w-fit sm:left-0 left-[0.1px] w-full mx-auto rounded-md right-0.5 text-gray-100 top-1 mt-10  mb-[67px] relative"
      >
      ...
      {mentorshipPackages &&
      mentorshipPackages.length > 0 &&
      mentorshipPackages[mentorshipPackages.length - 1].paymentPending ===
        false &&
      mentorshipPackages[mentorshipPackages.length - 1].sessionsConfirmed ===
        false ? (
        <p
          class={` ${
        ...
        <>
          ...
          {isMentor ? (
            <button
              ...
              class="uppercase bg-gradient-to-tr bottom-3  from-orange-600 to-orange-300 hover:from-orange-600 hover:to-orange-400 hover:shadow-xl active:shadow-sm text-white font-semibold mt-3 shadow-md relative top-5 w-1/2 mx-auto block mb-10 p-3 px-3 rounded-md"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 mr-1.5 relative bottom-[1.3px] inline"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
          ...
          <>
            ...
            {sessionsConfirmed ? (
              <div class="xl:w-8/12 w-full mb-3 xl:mb-0 px-3">
                <MentorshipSchedule mentorshipPackages={mentorshipPackages} />
              </div>
            ) : (
              ""
            )}
            ...
            <div
              className={`w-full xl:w-${
                sessionsConfirmed === true ? "1/2" : "4/12"
              } mb-3 xl:mb-0 px-3`}
            >
              {mentorshipPackages &&
              mentorshipPackages.length > 0 &&
              mentorshipPackages[mentorshipPackages.length - 1]
                .paymentPending === true ? (
