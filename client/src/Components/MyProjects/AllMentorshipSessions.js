...
<>
<h3 class = 'font-semibold text-center mx-auto mt-2 mb-1 top-1 relative text-2xl px-24'>View <span class = 'text-blue-700'>All Session</span> Details</h3>
<button onClick={()=>setShowDetails(true)} style = {{'backgroundImage':'url(https://media.istockphoto.com/photos/digital-cyberspace-with-particles-and-digital-data-network-high-picture-id1302189748?b=1&k=20&m=1302189748&s=170667a&w=0&h=s0o2dhTh40lrWLPt6rg54S0jCUywkr6h04rDdfStMq8=)'}}
 class = 'text-center p-3.5 bg-gradient-to-br from-blue-50 to-blue-300 active:shadow-sm rounded-md hover:text-violet-200 hover:ring-violet-400 hover:ring-2 hover:shadow-2xl hover:shadow-indigo-200 text-gray-100 shadow-md block justify-center mt-8 relative mx-auto hover:from-blue-100 hover:to-blue-500'>
...
<p class = 'text-center mt-4 w-1/3 mx-auto justify-center font-semibold text-gray-800 '>Click here to view details..</p>
</>
