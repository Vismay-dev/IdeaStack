...
const AllProjects = () => {
    ...
    return (
        ...
        <div class = {`grid grid-cols-2 gap-4 align-middle content-center ${projectCon.projects.length === 0? '-mb-14':'-mb-[187px] top-2 relative'} mt-6 pb-3 md:px-[20px]    lg:px-[120px] sm:px-[70px] px-[19px]  sm:left-1.5 left-1`}>
        {
        
        projectCon.projects.length===0?


        <p class = 'text-4xl font-semibold col-span-2 text-center mt-[70px] -mb-4 right-1 mx-auto relative'><svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 inline text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
