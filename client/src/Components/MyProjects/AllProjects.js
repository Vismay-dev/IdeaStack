...
const AllProjects = () => {
    ...
    return (
        ...
        <div class = {`grid grid-cols-2 gap-4 align-middle content-center ${projectCon.projects.length === 0? '-mb-14':'-mb-[187px] top-2 relative'} mt-4 md:px-[20px]    lg:px-[120px] sm:px-[70px] px-[19px]  sm:left-1.5 left-1`}>
