...
<h2 class = 'text-center font-bold sm:text-5xl text-4xl sm:px-0 px-8 text-gray-800 top-1 relative sm:mt-10 mt-11 sm:-mb-2.5 -mb-4'><svg xmlns="http://www.w3.org/2000/svg" class="md:h-10 md:w-10 h-8 w-8 mr-1 inline relative bottom-[3px]" viewBox="0 0 20 20" fill="currentColor">
