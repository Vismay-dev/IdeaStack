  ...
  return (
      ...
      <div class="flex space-x-1 overflow-hidden bg-gradient-to-l from-gray-300 to-slate-50 shadow-md py-1 pt-5 justify-center xl:w-10/12 w-full md:pr-16 sm:pr-32 pr-[130px] rounded-b-lg mx-auto">
        ...
        ${
          location.pathname === "/myprojects/allprojects"
            ? "bg-gray-800"
            : "bg-gray-500"
        } space-x-1 sm:px-7 sm:py-2 px-4 py-1 border border-b-0  border-gray-300 sm:text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
            >
        ...
        ${
          location.pathname === "/myprojects/joinrequests"
            ? "bg-gray-800"
            : "bg-gray-500"
        }  space-x-1 sm:px-8 sm:py-2 px-3.5 py-1 border border-b-0  border-gray-300 text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
            >
              <p>
                Join <span class="sm:inline hidden">Requests & Invites</span>
              </p>
            </button>
            ...
            <button
              ...
              class={`flex items-center h-12 pt-0.5  text-center text-gray-100 
        ${
          location.pathname === "/myprojects/createproject"
            ? "bg-gray-800"
            : "bg-gray-500"
        } space-x-1  sm:px-8 sm:py-2 px-4 py-1 border border-b-0  border-gray-300 text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
            >
        ...
        hover:from-gray-600 hover:to-gray-700 bg-gradient-to-b from-gray-500 to-gray-500 border-1   sm:px-4 px-1.5 py-1  border-b-0   text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
          ...
          <>
            {location.pathname !==
            "/myprojects/manageproject/mentorship/browse" ? (
              <>
                <button
                  onClick={() => {
   ...
   bg-gray-500 md:px-5 px-3 border border-b-0 hover:bg-gray-600  border-gray-300 sm:text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
                >
                  <svg
                    ...
                    class="h-6 w-6 inline lg:mr-1.5 top-[0.03px] relative"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                  ...
                  <span class="relative bottom-[0.016px] lg:inline hidden font-semibold">
                    {" "}
                    Go Back{" "}
                  </span>
                </button>
        ...
        ${
          location.pathname === "/myprojects/manageproject/manageapps"
            ? "bg-gray-800"
            : "bg-gray-500"
        } md:px-6 px-3 border border-b-0  border-gray-300 sm:text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
                  >
   ...
   bg-gray-500 px-7 border border-b-0 hover:bg-gray-600  border-gray-300 sm:text-base  rounded-t-md   whitespace-nowrap focus:outline-none`}
              >
                ...
                <span class="relative bottom-[0.016px] font-semibold">
                  {" "}
                  Go Back{" "}
                </span>
              </button>
