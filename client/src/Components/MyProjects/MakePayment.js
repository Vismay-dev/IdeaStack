...
const MakePayment = (props) => {
    ...
    <div style = {{'backgroundImage':payment===0? 'url(https://c0.wallpaperflare.com/preview/134/372/59/abstract-background-copyspace-brainstorm.jpg)':"url(https://www.vapulus.com/en/wp-content/uploads/2021/02/challenge-accepting-online-payments-technical-issue-1024x768-1.png)"}} 
...
<p className="text-center top-2 text-xl px-10 font-semibold relative text-white">
<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 bottom-[1.5px] mr-0.5 relative inline text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  ...
  <h3 class = 'font-semibold text-center mx-auto mt-7 mb-7 text-[16px] px-6 text-white'>Awaiting Payment from <span class = 'text-slate-300'>Other Team Members. </span> Session to be Scheduled on <span class = 'text-slate-300'>Completion of Team Payment </span>...</h3>
  <button  class = 'bg-indigo-500  uppercase p-3 hover:ring-1 hover:ring-blue-400 hover:bg-indigo-600 hover:shadow-lg active:shadow-sm rounded-lg text-sm mx-auto relative block right-[8px] shadow-md py-2.5 mt-7 mb-1 text-white font-semibold'>Download Payment Invoice</button>
