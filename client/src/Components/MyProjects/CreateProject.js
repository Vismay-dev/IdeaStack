...
<p class = 'sm:text-4xl text-2xl font-semibold col-span-2 text-center mt-[65px] px-3 right-3 mb-0 pb-[86px] mx-auto relative'><svg xmlns="http://www.w3.org/2000/svg" class="sm:h-9 sm:w-9 h-7 w-7 inline text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
