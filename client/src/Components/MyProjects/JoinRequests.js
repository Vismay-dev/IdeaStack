...
const JoinRequests = () => {
  ...
  return (
    <>
      <h1 class=" text-center w-10/12 relative mx-auto md:mb-0 -mb-3   md:mt-6 mt-4 py-4 pb-[10px] underline font-semibold text-gray-800 md:text-[47px] text-[38px] ">
        Join Requests ({arr1 ? arr1.length : ""})
      </h1>
      ...
      >
        {loading ? (
          ...
          arr1.length === 0 ? (
            <p class="smd:text-4xl sm:text-3xl text-2xl font-semibold md:col-span-3 sm:col-span-2 col-span-1 text-center mt-[50px] sm:-mb-80 -mb-[360px] right-1 mx-auto relative">
              <svg
      ...
      <div
        class={`grid ${
          ...
          (arr2 && arr2.length === 0) || loading
            ? "sm:mb-[4rem] mb-[3rem] sm:pb-6 pb-6 sm:pt-[54px] pt-[46px]"
      ...
      >
        {loading ? (
          ...
          arr2.length === 0 ? (
            <p class="smd:text-4xl sm:text-3xl text-2xl font-semibold md:col-span-3 sm:col-span-2 col-span-1 text-center mt-[70px] -mb-[400px] right-1 mx-auto relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="md:h-10 sm:h-8 h-6 w-6 md:w-10 sm:w-8  inline text-blue-700"
                fill="none"
