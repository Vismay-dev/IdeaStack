...
const Footer = () => {
    ...
    return (
        ...
        <footer className={`px-4 lg:py-10 sm:py-3 pt-0 pb-3 dark:bg-blue-900 opacity-80 dark:text-gray-100 ${location.pathname==='/home'?'sm:mt-[460px] mt-[360px]':'sm:mt-[205px] mt-[140px]'} md:-mb-80 -mb-102 relative lg:top-[160px] md:top-[139px] top-[132px]`}>
        <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
            ...
            <a href="#" title="Facebook" className="flex items-center p-1">
					...
					<a href="#" title="Twitter" className="flex items-center p-1">
						<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="md:w-7 md:h-7 w-5 h-5 text-white">
							<path d="M23.954 4.569a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.691 8.094 4.066 6.13 1.64 3.161a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.061a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.937 4.937 0 004.604 3.417 9.868 9.868 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63a9.936 9.936 0 002.46-2.548l-.047-.02z"></path>
						</svg>
					</a>
					<a href="#" title="Instagram" className="flex items-center p-1 text-white">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="md:w-7 md:h-7 w-5 h-5 fillCurrent">
