                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    <p className="mb-4 text-md leading-relaxed text-blueGray-700">
                      {editingDesc ? (
                        <>
                          <h1 class="text-3xl -mt-2 mb-4 font-semibold text-center text-gray-700">
                            Edit Description
                          </h1>
                          <br />
                          <textarea
                            ...
                            class="text-black mx-auto border-2 w-11/12 h-44 shadow-lg rounded-md mb-4 -mt-3 p-3 border-gray-300"
                          ></textarea>
                          ...
                          <div class="space-x-4 mb-8 justify-end justify-items-end">
                            <button
                              ...
                              class="w-1/3 font-semibold p-2 shadow-md  z-20 bg-gray-100 hover:bg-gray-200 px-12 rounded-md hover:cursor-pointer hover:text-indigo-600 text-blue-600"
                            >
                              Cancel
                            </button>
                            ...
                            <button
                              ...
                              class="font-semibold w-1/2   p-2 shadow-md  z-20 bg-gray-100 hover:bg-gray-200 px-8 rounded-md hover:cursor-pointer hover:text-indigo-600 text-blue-600"
                            >
                              Submit
                            </button>
                          </div>
                        ...
                        <>
                          ...
                          <textArea
                            ...
                            required
                            onChange={changeHandler}
                            placeholder="Add Description - Your Background in STEM, Your Education, Summarize who you are"
                            class="text-black mx-auto border-2 w-11/12 h-44 shadow-lg rounded-md mb-4 -mt-3 p-3 border-gray-300"
                          ></textArea>
                    ...
                    <button
                      class={`font-semibold ${
                        !showmore ? "z-[75]" : "z-30"
                      }  pointer-events-auto top-3 p-2 text-md shadow-md mb-2 bg-gray-100 hover:bg-gray-200 px-4 rounded-md hover:cursor-pointer hover:text-indigo-600 relative text-gray-700`}
                      onClick={() => {
                  ...
                  {showmore ? (
                    <div class="container mt-16  -mb-6 px-10">
                              ...
                              return (
                                <div
                                  class={`w-full relative  mx-auto py-2 pb-1 ${
                                    currentUser.user.interests.length === 1
                      ...
                      <h1 class="font-semibold text-4xl w-48 mx-auto relative bottom-6 mb-3 text-center justify-center inline-block justify-items-center">
                        ...
                        <div class="relative lg:left-20 sm:left-6 -left-4 sm:bottom-4 -bottom-5 z-[20]">
                          <Tooltip
                            ...
                            position="bottom"
                          >
                            <span class="font-medium text-center leading-[24px] font-sans">
                              Includes projects you've created and joined...
                            </span>
                          </Tooltip>
                        </div>
                      </h1>{" "}
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-6 w-6 sm:-mt-[58px] -mt-[35px] sm:top-0 top-6 relative mx-auto sm:mx-0 lg:left-8 left-1 hover:text-indigo-500 sm:inline block"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="2"
