...
export default function Dropdown(props) {
  ...
  return (
    <Menu
      as="div"
      className="relative sm:inline-block block md:text-md text-sm z-[100] sm:px-0 px-9  sm:mt-0 -mt-2.5 sm:mb-0 mb-2  sm:ml-5 mx-auto text-left"
    >
      <div class="z-[100]">
        <Menu.Button className="py-2 z-[100]  inline-flex justify-center w-full sm:border-[1px] rounded-md sm:border-gray-300 shadow-md px-4 bg-white text-md font-medium text-gray-700 hover:bg-gray-50 focus:outline-none  ">
          {catSelected
            ? catSelected === "All"
              ? "All Categories"
                  ...
                  {({ active }) => (
                    <a
                      ...
                      className={classNames(
                        active
                          ? "bg-gray-100 cursor-pointer text-gray-900 font-semibold"
                          : "text-gray-700",
