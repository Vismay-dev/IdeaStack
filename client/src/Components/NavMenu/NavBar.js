...
useEffect(
  ...
  return (
   <div class = 'z-50'> 
    ...
    <div  class={`mx-auto w-screen lg:px-20 md:px-32 px-10 shadow-lg md:h-fit ${sessionStorage.getItem('token')===null?'sm:h-[105px]':'sm:h-[142px]'} relative sm:fixed h-[90px] bg-white  z-[80] `}>
