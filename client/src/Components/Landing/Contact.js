...
const Contact = () => {
    ...
    axios
      .post(
        process.env.NODE_ENV === "production"
          ? "https://ideastack.herokuapp.com/api/user/sendUserQuery"
          : "http://localhost:4000/api/user/sendUserQuery",
        mailer
      )
      .then((res) => {
  ...
  return (
    <section
      id="contact"
      class=" xl:py-[140px] xl:pb-28  pt-[100px] pb-[130px] lg:py-[100px] lg:pb-[100px] -mb-[516px] border-t-2 border-dashed border-blue-700  overflow-hidden relative z-75"
    >
        ...
        <div class="flex flex-wrap  top-4     mx-auto justify-center">
          <div class="w-full xl:ml-12 xl:mr-0 lg:w-full  justify-center  mx-auto xl:w-6/12 px-8">
            <div
              data-aos="fade-up"
              data-aos-once="true"
              class="max-w-[570px] mb-7 lg:-mb-2 relative xl:top-5 -top-6 xl:mx-0 mx-auto"
            >
              ...
              <p class="text-base xl:text-left text-center text-body-color leading-relaxed mb-9">
                Any queries? Send us a message. We'll respond as soon as
                possible!
              </p>
              <div class="flex mb-8 xl:mx-0 mx-auto max-w-[370px] w-full">
                ...
                <div class="w-full">
                  <h4
                    class="font-bold text-dark text-xl xl:text-left
                                 text-center mb-1"
                  >
                    Our Location
                  </h4>
                  <p
                    class="text-base xl:text-left
              ...
              <div class="flex mb-2 xl:mx-0 mx-auto max-w-[370px] w-full">
                ...
                <div class="w-full">
                  <h4
                    class="font-bold text-dark text-xl mb-1 xl:text-left
                                 text-center"
                  >
                    Email Address
                  </h4>
                  <p
                    class="text-base text-body-color xl:text-left
                                 text-center"
                  >
          ...
          <div class="w-full lg:w-1/2 xl:w-5/12 xl:right-12 top-4  z-75 relative px-4">
            <div
              ...
              data-aos-once="true"
              delay="200"
              class="bg-gradient-to-r  z-75 from-blue-100 to-indigo-300  relative rounded-lg p-8 sm:p-12 shadow-lg"
            >
              {!loading ? (
                <form onSubmit={formSub} class="z-75">
                  <div class="mb-6">
                    <input
