...
const Contact = () => {
    ...
    return (
        ...
        <div class={`bg-gradient-to-b from-purple-600 to-blue-700 ${loading?'h-40':'h-96'} w-full`}>
            ...
            <div class="w-full  flex items-center justify-center md:my-12 mb-8">
                <div class="relative md:top-24 top-24 bg-white shadow  rounded-md py-12 md:mb-80  lg:px-56 md:px-44 sm:px-20    px-10">
                    ...
                    <div class="md:flex items-center mt-16 xs3:w-72 w-64 md:mr-32 mx-auto">
                        <div class="md:w-72 xs2:w-96 xs3:w-72 flex flex-col">
                            ...
                            <input tabindex="0" arial-label="Please input name" type="name" class="text-base leading-none text-gray-900 xs2:p-3 p-2 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100" onChange={nameChange} placeholder="Please input  name" />
                        </div>
                        <div class="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            ...
                            <input tabindex="0" arial-label="Please input email address" type="name" class="text-base leading-none text-gray-900 xs2:p-3 p-2 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100"  onChange={mailChange} placeholder="Please input email address" />
                        </div>
                    </div>
                    <div class="md:flex items-center mt-8 xs3:w-72 w-64 md:mr-32 mx-auto">
                        <div class="md:w-72 flex flex-col">
                            ...
                            <input tabindex="0" role="input" arial-label="Please input company name" type="name" class="text-base leading-none text-gray-900 xs2:p-3 p-2 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100" onChange={compnameChange} placeholder="Please input company name" />
                        </div>
                        <div class="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label class="text-base font-semibold leading-none text-gray-800">Country</label>
                            <input tabindex="0" arial-label="Please input country name" type="name" class="text-base leading-none text-gray-900 xs2:p-3 p-2 focus:oultine-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100" onChange={countryChange} placeholder="Please input country name" />
                        </div>
                    </div>
                    <div>
