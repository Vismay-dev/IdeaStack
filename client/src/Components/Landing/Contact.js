...
const Contact = () => {
    ...
    return (
            ...
            <section id = "contact" class=" xl:py-32 lg:mt-12 mt-4 xl:pb-36 py-[125px] pb-36 lg:py-[120px] -mb-[300px] border-t-2 border-dashed border-blue-700  overflow-hidden relative z-20">
                        ...
                        <div data-aos="fade-up" data-aos-once='true' class="max-w-[570px] mb-7 lg:-mb-2 relative xl:top-5 -top-6 xl:mx-0 mx-auto">
                           ...
                           <div class="flex mb-8 xl:mx-0 mx-auto max-w-[370px] w-full">
                              ...
                              <div class="w-full">
                                 ...
                                 text-center">ideastackapp@gmail.com</p>
                              </div>
                           </div>
                        </div>
                     </div>
