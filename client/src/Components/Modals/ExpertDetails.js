        ...
        axios
          ...
          .then((res) => {
            for (let k = 0; k < res.data.length; k++) {
              if (
                JSON.stringify(res.data[k]._id) === JSON.stringify(expert._id)
              ) {
                setPackageyum(true);
              }
            }
          ...
          <div className="pt-6  -mb-[80px] relative">
            ...
            {!showConfirm ? (
                  ...
                  <div className="mt-10 lg:pl-4 lg:-left-2 relative lg:mt-0 lg:-top-2 lg:row-span-3">
                    ...
                    {expert && expert.pricing[1] !== 0 && isFirstFree ? (
                      <p className="md:text-xl text-md text-gray-600">
                        First {expert.pricing[1] !== 1 ? expert.pricing[1] : ""}{" "}
              ...
              <>
                ...
                <h2
                  class={`font-bold underline text-xl relative top-7 mt-12 block mb-3 text-center ${
