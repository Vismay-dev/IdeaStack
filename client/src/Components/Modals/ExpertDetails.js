...
console.log(isMentor)
    ...
    return (
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div ref = {myRef} data-aos={"fade-up"} data-aos-once='true' class={`bg-cover inline-block align-bottom bg-white rounded-lg ${showConfirm?'bg-gradient-to-br from-indigo-50 to-indigo-200':''} text-left overflow-hidden shadow-xl transform transition-all sm:my-8 lg:pb-0 pb-7 lg:px-3 ${showConfirm?'px-1':'px-5'} sm:mt-5 sm:align-middle xl:w-10/12 md:w-11/12 w-[97%]`}>
        ...
        <div className="max-w-2xl mx-auto pt-14 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl lg:text-3xl">{expert && expert.name}</h1>
          ...
          <div className="pb-14 pt-2 lg:pt-6 lg:pb-16 lg:col-start-1 -mb-3 lg:col-span-2 lg:border-r  lg:border-gray-200 lg:pr-8">
            ...
            <div>
              ...
              <div className="space-y-6 mt-3 relative">
                <p className="lg:text-base text-sm text-gray-900">{expert && expert.mentorshipProp}</p>
              </div>
            </div>
...
disabled = {!isMentor||packageyum}
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 lg:block hidden absolute text-center justify-center xl:left-[36%] left-[33%] text-blue-700 mx-auto top-[57.5%] translate-y-[-60%]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
</svg>


        <div class = 'grid grid-cols-2 xl:right-[5%] lg:right-[7%] my-40 mt-24 lg:px-0 px-12 relative'>

        <div 
    class="max-w-xs bg-cover mb-8 mt-12 relative lg:block hidden mx-auto  bg-white rounded-lg bottom-5 shadow-lg dark:bg-gray-800">
        ...
        <div class="xl:w-11/12 sm:w-full w-[114%] lg:-mb-0 sm:-mb-5 -mb-14 sm:right-0 right-[7%] lg:col-span-1 col-span-2 -top-5 relative block mx-auto   lg:px-2">
          <div class="pb-6 p-10 md:pb-7  md:p-12 rounded-sm shadow-lg bg-blue-700">
          <h2 class="sm:mb-3 mb-1.5 md:text-left text-center relative bottom-3 lg:text-4xl sm:text-3xl text-2xl lg:hidden block font-bold font-heading text-white">Mentor: {expert&& expert.name} </h2>
          <h2 class="mb-7 relative bottom-3 md:text-left text-center lg:text-4xl sm:text-xl text-lg lg:hidden block font-bold font-heading text-gray-200">{expert&& expert.role} </h2>
            ...
            <h4 class="sm:mb-2 mb-4 text-xl relative bottom-2 font-bold sm:mt-0 mt-2 font-heading text-white">Pricing</h4>
            <div class="sm:flex mb-2 sm:justify-between items-center">
              <span class="text-blue-50 text-md sm:mb-0 mb-2 sm:no-underline underline relative">Individual Payment Per Session</span><br class = 'sm:hidden block'/>
