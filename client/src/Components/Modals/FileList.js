...
function convertDate(inputFormat) {
  ...
  let dateUploaded = convertDate(doc.dateOfUpload) 
                                    ...
                                    <td>
                                        <div class="ml-5">
                                            <div class="rounded-sm w-5 -mr-2  h-5  flex flex-shrink-0 justify-center items-center relative">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 top-[0.5px] relative text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      <path stroke-linecap="round" stroke-linejoin="round" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                                    ...
                                    <td class="">
                                        <div class="flex items-center pl-5">
                                            <p class="text-sm font-medium leading-none text-gray-700 mr-2">{doc.title}</p>
                                           
                                        </div>
                                    </td>

                                    <td class="pl-24 ">
                                        {doc && doc.isImportant||doc.isImportant==='on'?
                                        <div class="flex items-center text-indigo-500 font-semibold ">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 top-[1px] relative" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      <path stroke-linecap="round" stroke-linejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
    </svg>
                                            <p class="text-sm leading-none text-indigo-500 ml-[5px]">Important</p>
                                        </div>:''}
                                    </td>
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                            ...
                                            <p class="text-sm leading-none text-gray-600 ml-2">{doc.downloads}</p>
                                        </div>
                                    </td>
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            ...
                                            <p class="text-sm leading-none text-gray-600 ml-2">{dateUploaded}</p>
                                        </div>
                                    </td>
                                    <td class="pl-5">
