...
const FileList = () => {
  ...
  const toggleDocVisibility = (i) => {
    const newFileArr = docs;
    newFileArr[i].visibleToMentors = !newFileArr[i].visibleToMentors;
    axios
      .post(
        process.env.NODE_ENV === "production"
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <div
              class="flex p-4 py-2 mb-4 mt-6 w-fit mx-auto text-sm text-indigo-800 border border-indigo-300 rounded-lg bg-white"
              role="alert"
            >
              <svg
                aria-hidden="true"
              ...
              <div>
                <span class="font-semibold mr-1">Visibility:</span> Click on
                'Visible/Invisible to Mentors' to change visibility of file
              </div>
            </div>
                          ...
                          >
                            ...
                            <td class=" pl-5">
                              {doc && doc.visibleToMentors ? (
                                <div
                                  data-tip={"Make this invisible to mentors"}
                                  onClick={() => toggleDocVisibility(i)}
                                  class="flex hover:text-indigo-600 hover:underline cursor-pointer  items-center text-gray-600 font-semibold "
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                  ...
                                  <p class="text-sm leading-none  ml-[5px]">
                                    Visible to Mentors
                                  </p>
                                </div>
                              ) : (
                                <div
                                  data-tip={"Make this visible to mentors"}
                                  onClick={() => toggleDocVisibility(i)}
                                  class="flex hover:text-indigo-600 hover:underline cursor-pointer  items-center text-gray-600 font-semibold "
                                >
                                  <svg
