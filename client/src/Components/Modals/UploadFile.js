                        ...
                        <div class="flex items-center justify-center w-full">                            <label class={`flex flex-col ${error==='Not Uploaded'?'border-red-400':''} rounded-lg border-4 border-dashed w-full h-60 sm:p-10 p-10 px-3 group text-center`}>
{
                            ...
                            <ClipLoader color={'#3678D7'} loading={uploading}  size={70} />
                            </div>
                    ...
                    <div>
                        <button type="submit" class="mt-7 mb-2 w-full flex justify-center bg-blue-600 text-gray-100 p-2  rounded-lg tracking-wide
                    ...
                    <button onClick = {props.close} class=" mt-3 w-full flex justify-center bg-orange-400 text-gray-100 p-2  rounded-lg tracking-wide
