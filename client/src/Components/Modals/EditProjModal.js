  ...
  [myRef, () => props.close()]
    ...
    return (
      ...
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div ref = {myRef} data-aos={"fade-up"} data-aos-once='true' class="pr-6 inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:mt-5 sm:align-middle md:w-10/12 sm:w-11/12 w-[95%]">
...
<textarea type="number" name = 'problem' min = {140} max = {200} onChange={changeHandler} value = {project.problem}  id="problem" class="block top-3 relative  w-full text-sm text-gray-900 bg-transparent border-2 border-gray-300 appearance-none    focus:outline-none focus:ring-0 focus:border-blue-600 peer h-32 p-2  rounded-md" placeholder=" " required={true}/>
