                            ...
                            onClick={() => {
                              if (props.isRemoving) {
                                axios
                                  .post(
                                    process.env.NODE_ENV === "production"
                                      ? "https://ideastack.herokuapp.com/api/project/removeMember"
                                      : "http://localhost:4000/api/project/removeMember",
                                    {
                                ...
                                axios
                                  .post(
                                    process.env.NODE_ENV === "production"
                                      ? "https://ideastack.herokuapp.com/api/project/leaveProject"
                                      : "http://localhost:4000/api/project/leaveProject",
                                    {
                                      token: sessionStorage.getItem("token"),
                                      member: props.member,
                                      projectID:
