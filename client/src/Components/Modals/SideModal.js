...
useEffect(
  ...
  [myRef, () => props.close()]
    ...
    <img src = {logo} className="w-40 bg-white relative mb-24 shadow-md rounded-md mt-5 mx-auto right-1 top-12 "/>


    <div class="relative mt-10">
        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
            <svg class="w-5 h-5 bottom-4 relative text-gray-400" viewBox="0 0 24 24" fill="none">
                <path d="M21 21L15 15M17 10C17 13.866 13.866 17 10 17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
        </span>

        <input type="text" class="w-full py-2 pl-10 mb-8 pr-4 text-gray-900 bg-white border rounded-md  focus:border-blue-00  focus:ring-blue-700 focus:ring-opacity-40 focus:outline-none focus:ring" placeholder="Search"/>
    </div>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-700 transition-colors duration-200 transform rounded-md  bg-white shadow-sm hover:shadow-md hover:bg-gray-200 active:shadow-md  hover:text-gray-900" href="#">
                ...
                <span class="mx-4 font-semibold">Accounts</span>
            </a>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-700 transition-colors duration-200 transform rounded-md  bg-white shadow-sm hover:shadow-md hover:bg-gray-200 active:shadow-md  hover:text-gray-900" href="#">
                ...
                <span class="mx-4 font-semibold">Tickets</span>
            </a>
            ...
            <hr class="my-12 border-white border-2 " />
