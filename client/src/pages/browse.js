  ...
  return (
    <>
      ...
      <div
        style={{
          "background-image":
            "url(https://media.istockphoto.com/photos/dark-blue-grunge-background-picture-id185007737?b=1&k=20&m=185007737&s=170667a&w=0&h=2HRmWnMNz-WdJ9jQ94PksQlATGq6QSIvSyVQOOBbSTY=)",
        }}
        className="shadow-md  bg-cover bg-center  bottom-4   w-full flex justify-center mx-auto pt-9 p bg-gradient-to-r from-gray-100 px-6 to-gray-300"
      >
        <div>
          <h1 className="xl:text-7xl md:text-6xl text-5xl  relative text-center text-gray-50 font-extrabold md:pb-6 md:pt-0 pt-1 pb-3.5 mb-4  mx-auto">
            {" "}
            Browse Projects
          </h1>
        </div>
      ...
      <div class="sm:flex block -space-x-4 bg-gradient-to-l from-gray-300 to-slate-50 shadow-md py-4 pb-4 justify-center  w-full rounded-b-lg  mx-auto">
        <div
          data-aos={"fade-right"}
          data-aos-once="true"
          class="sm:flex block pointer-events-auto z-[70] items-center justify-center relative"
        >
          <div class="flex justify-center sm:border-[1px] rounded-md sm:-mr-3 mx-auto sm:border-gray-300">
            <input
              type="text"
              onChange={textChangeHandler}
              class="px-4 py-2  md:text-md text-sm sm:w-64 w-36 shadow-md rounded-l-[4px] border-0"
              placeholder="Search Project"
            />
            <button
              onClick={() => filterByText()}
              class="flex items-center hover:shadow-lg hover:bg-blue-700 rounded-r-[4px] active:shadow-sm shadow-md justify-center px-4 border-l bg-blue-600"
            >
              <svg
      ...
      <div class="flex flex-wrap mx-auto md:mt-14 mt-12  md:-mb-52 -mb-48 top-2 relative gap-y-12 md:px-[40px] sm:px-24 lg:px-24 px-7 ">
        {loading ? (
          ...
          projects.map((proj, i) => {
            ...
            return (
              <div
                class={`md:w-1/2 w-full xl:w-1/3   sm:px-4 px-4 z-[50] pointer-events-auto`}
              >
                <div
                  data-aos={"fade-up"}
                  data-aos-once="true"
                  class={`rounded-lg pointer-events-auto z-40 shadow-lg bg-gradient-to-r relative  from-blue-50 to-indigo-100 `}
                >
                  <img
                    src={proj.projPic}
                    alt="image"
                    class="w-full h-56 object-contain py-7 -mb-3 bg-gray-50 rounded-t-md border-b-[3px] border-gray-400 relative"
                  />
                ...
                "
                      ...
                      <span class="text-sm mx-auto relative font-semibold text-gray-600 ">
                        {date}
                      </span>
                    </h3>

                    <div
                      class={`align-middle inline-block relative ${
                        String(proj.problem).length < 155 ? "md:top-6" : ""
                      }`}
                    >
                      ...
                      <button
                        ...
                        class="bg-gradient-to-br  from-blue-400 to-indigo-400 relative  z-[75] pointer-events-auto active:shadow-md mx-auto w-[110px]  justify-center xl:w-[120px] lg:w-[110px] md:w-[110px]  -mt-2  -mb-6 items-center shadow-lg hover:from-blue-700 hover:to-blue-600 text-white p-1.5  px-2 rounded-md sm:text-lg text-md   hover:cursor-pointer"
                      >
                        View More
                      </button>
                    </div>
